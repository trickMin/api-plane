...
public class JsonpProcessor extends AbstractSchemaProcessor implements SchemaProcessor<ServiceInfo> {
    ...
    public FragmentHolder process(String plugin, ServiceInfo serviceInfo) {
        ...
        ResourceGenerator builder = ResourceGenerator.newInstance(String.format("{\"transformation\":{\"responseTransformations\":[{\"transformationTemplate\":{\"extractors\":{\"all-body\":{\"header\":\":body\",\"regex\":\"([\\\\s\\\\S]*)\",\"subgroup\":1}},\"body\":{\"text\":\"%s({{all-body}})\"},\"parseBodyBehavior\":1},\"conditions\":{\"context\":{\"request_method\":\"GET\"},\"headers\":{\"name\":\"Content-Type\",\"regex\":\".*application/json.*\"}}}]}}", callback));
