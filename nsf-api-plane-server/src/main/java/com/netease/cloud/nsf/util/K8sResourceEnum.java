...
public enum K8sResourceEnum {
    ...
    ClusterRbacConfig(RbacConfig.class, null, "/apis/rbac.istio.io/v1alpha1/clusterrbacconfigs"),
    SharedConfig(null, null, "/apis/networking.istio.io/v1alpha3/namespaces/%s/sharedconfigs"),
    ;
