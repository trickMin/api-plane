package com.netease.cloud.nsf.util.rest;
...
public class RestTemplateClient {
    ...
    public File downloadFile(String url, String filePath) {
        ...
        try {
            ...
            headers.add("Interface-Type", Const.INTERFACE_CALL_TYPE_INNER);
            ...
            String response = e.getResponseBodyAsString();
            logger.info("error response:{}", response);
            throw new ApiPlaneException(parseErrorMsg(response), e.getRawStatusCode());
        } catch (HttpServerErrorException e) {
            throw new ApiPlaneException(INNER_ERROR_MSG, 500);
        } catch (RestClientException e) {
            throw new ApiPlaneException(e.getMessage(), 500);
