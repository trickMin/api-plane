...
@Order(1)
@Component
class K8sCustomResouceClient extends AbstractK8sClient<IstioResource> {

    private static final Logger logger = LoggerFactory.getLogger(K8sCustomResouceClient.class);
